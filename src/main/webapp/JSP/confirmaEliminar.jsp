            ...
            <table>
                ...
                <c:forEach items="${sessionScope.usuariosEliminar}" var="usuario">
                    <tr>
                        ...
                        <td class="centro">
                            <img src="<c:url value='/img/${usuario.avatar}'/>" alt="avatar usuario" title="Avatar de usuario" width="50" height="50"/>
                            <img src="<c:url value='/img/${usuario.avatarPart}'/>" alt="avatar usuario" title="Avatar de usuario" width="50" height="50"/>
                        </td>
                    </tr>
                </c:forEach>
            </table>
