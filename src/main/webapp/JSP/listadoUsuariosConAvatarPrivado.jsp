                ...
                <tbody>
                    <c:forEach items="${requestScope.userPrivado}" var="usuario">
                        <tr>
                            ...
                            <td class="centro"><img src="<c:url value='/img/${usuario.avatar}'/>" alt="avatar usuario" title="Avatar de usuario" width="50" height="50"/></td>
                            <td class="centro"><img src="<c:url value='/img/${usuario.avatarPart}'/>" alt="avatar usuario" title="Avatar de usuario" width="50" height="50"/></td>
                            <c:set var="defecto" value="default.png" />
                                <c:choose>
                                <c:when test="${usuario.avatarPrivado == null}">
                                    <td class="centro"><img src="<c:url value='/img/default.png'/>" alt="avatar privado" title="Avatar" width="50" height="50"/></td>
                                    </c:when>
                                    <c:otherwise>
